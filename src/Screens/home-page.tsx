...
export default function Homepage() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image source={''}/>
      <Button label={'Customer'} size={Button.sizes.large} backgroundColor={'#bf6240'} text60BO/>
      <Button label={'Business'} size={Button.sizes.large} backgroundColor={'#bf6240'} text60BO/>
      </ImageBackground>
    </View>
  )
}
